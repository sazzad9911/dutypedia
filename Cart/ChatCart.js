...
import {View,TouchableOpacity,
    Text,Image,StyleSheet,Dimensions} from 'react-native'
...
const ChatCart = (props) => {
    ...
    return (
        <TouchableOpacity onPress={()=> navigation.navigate('ChatScreen')} style={styles.outBox}>
            ...
            <Text style={styles.text}>While you’re developing your project, of a you’re writing code on your computer</Text>
            </View>

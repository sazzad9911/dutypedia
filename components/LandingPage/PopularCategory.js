  ...
  return (
    <Pressable style={[styles.container,style]}>
      <Image
        style={styles.image}
        source={{
          uri: "https://www.usan.com/wp-content/uploads/2013/09/customer-self-service.jpg",
        }}
      />
      <View style={{flex:1,marginLeft: 7,}}>
        <View
          style={[customStyle.flexBox]}>
          <View
            style={{
              flex: 7,
            }}>
        ...
        <View style={[customStyle.flexBox]}>
            <Text style={[styles.smallText,{flex:1}]} numberOfLines={1}>Easin arafat It center</Text>
            <View style={{
                height:12,
                width:1,
            ...
            <Text style={[styles.smallText,{flex:2}]} numberOfLines={1}>Easin arafat it consulting service is the most powerful</Text>
        </View>
        <View style={customStyle.flexBox}>

...
export const TopSellerCard = ({width,style,height}) => {
  ...
  return (
    <Pressable style={[styles.container,width?st.width:null,style]}>
      <View>
        <Image
          style={[styles.image,width?st.width:null,height?{height:height}:null]}
          source={{
            uri: "https://www.cleansweepofamerica.com/wp-content/uploads/2020/10/office-cleaning-service.jpeg",
          }}
        />
        <TouchableOpacity style={styles.icon} onPress={()=>setLike(t=>!t)}>
        <AntDesign  name={like?"heart":"hearto"} size={16} color={like?"red":"#FFFFFF"} />
        </TouchableOpacity>
      </View>

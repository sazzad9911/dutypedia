    ...
    <SafeAreaView style={{ backgroundColor: "black" }}>
      ...
      >
        <View style={styles.container}>
          ...
          >
            <SvgXml xml={threeDot} height="50" width={"50"} />
            <SvgXml xml={loveIcon} height="50" width={"50"} />
            <SvgXml xml={shareIcon} height="50" width={"50"} />
            <SvgXml xml={newCalender} height="50" width={"50"} />
          ...
          >
            ...
            >
              <Text
                numberOfLines={NameDropDown?4:1}
                style={{
                  color: "#6366F1",
                  textAlign: "center",
                  flex: 1,
            ...
            >
              ...
              >
                Position of {Data ? Data.service.providerInfo.position : ""}
              </Text>
            </View>
            <View style={{ flex: 1 }} />
          </View>
                      ...
                      <ServiceCart
                        onPress={() => {
                          ...
                          try {
                            ...
                            setNewDataList(
                              serverToLocal(doc.services, Category)
                            );
                          } catch (e) {
                            console.log(e.message);
                          }

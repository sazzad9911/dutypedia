  ...
  return (
    <TouchableOpacity
      ...
      <View style={{ flexDirection: "row", alignItems: "center" }}>
        ...
        <SvgXml xml={right} height={"24"} width={"24"} />
      </View>
    </TouchableOpacity>
  );
};
...
<path d="M12.9 7.94001L15.52 10.56C16.29 11.33 16.29 12.59 15.52 13.36L9 19.87M9 4.04001L10.04 5.08001" stroke="#767676" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`;

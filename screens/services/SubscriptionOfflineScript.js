...
import { getSubsOfflineOrderById, getSubsOrderById } from "../../Class/service";
...
export default function SubscriptionOfflineScript({ navigation, route }) {
    ...
    >
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          >
            <Avatar source={{uri:userInfo.profilePhoto}}
              style={{
                height: 50,
                width: 50,
              }}
    ...
    <Pressable onPress={()=>{
      ...
      <View
        style={{
          ...
          opacity: data.offlineOrderId ? 1 : 0.4,
